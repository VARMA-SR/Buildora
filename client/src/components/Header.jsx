...
import { Home, User, Heart, PlusCircle, LayoutDashboard, LogOut, Menu, X, Shield, ArrowLeft } from 'lucide-react';
...
export default function Header() {
  ...
  return (
    <header className="navbar" style={{ padding: '20px 40px' }}>
      <div className="nav-container" style={{ width: '100%', maxWidth: '100%' }}>
        {/* Brand Logo */}
