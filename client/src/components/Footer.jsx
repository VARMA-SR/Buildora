...
import { Home, Mail, Phone, MapPin, Send, Facebook, Twitter, Instagram, Linkedin } from 'lucide-react';
    ...
    <footer className="footer">
      <div className="app-container">
        <div className="footer-grid">
          ...
          <div>
            <div className="brand-logo" style={{ marginBottom: '16px' }}>
              ...
              <span>Build<span style={{ color: 'var(--primary)' }}>ora</span></span>
            </div>
          ...
          <div>
            ...
            <ul style={{ listStyle: 'none', display: 'flex', flexDirection: 'column', gap: '10px', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
              ...
              <li><Link to="/about" className="nav-link">About Buildora</Link></li>
        ...
        <div className="footer-bottom">
          <p>© {new Date().getFullYear()} Buildora Real Estate Platform. All rights reserved.</p>
