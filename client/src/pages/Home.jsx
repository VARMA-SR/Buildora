...
export default function Home() {
  ...
  return (
    <div className="home-page">
        ...
        <div className="app-container" style={{ position: 'relative', zIndex: 2, width: '100%' }}>
          <div style={{ textAlign: 'center', maxWidth: '840px', margin: '0 auto 32px' }}>
            <div className="eyebrow-tag" style={{
              ...
              <Sparkles size={15} />
              <span>BUILDORA • INDIA'S PREMIER REAL ESTATE MARKETPLACE</span>
            </div>
      ...
      {/* Featured Properties */}
      <section style={{ padding: '70px 0', background: 'var(--cream)', borderTop: '1px solid var(--line)', borderBottom: '1px solid var(--line)' }}>
      ...
      <section style={{ padding: '80px 0', background: 'var(--bg-dark)' }}>
        <div className="app-container">
          <div style={{ textAlign: 'center', maxWidth: '640px', margin: '0 auto 50px' }}>
            <div className="eyebrow-tag" style={{ justifyContent: 'center', color: 'var(--gold)', borderColor: 'rgba(184, 138, 68, 0.3)' }}>BUILT ON TRUST</div>
            <h2 style={{ fontSize: '2.2rem', color: 'var(--text-dark-section)', marginBottom: '12px' }}>Experience That Builds Confidence</h2>
            <p style={{ color: 'var(--text-dark-section)', opacity: 0.8 }}>For over 15 years, we have delivered exceptional solutions. Built on transparency, verified listings, and direct owner communication.</p>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '28px' }}>
            {[
              ...
              <div key={item.step} className="glass-panel" style={{ padding: '32px', background: 'var(--sage)', borderColor: 'rgba(255,255,255,0.05)' }}>
                <div style={{ fontSize: '2rem', fontWeight: 800, color: 'var(--gold)', marginBottom: '12px' }}>{item.step}</div>
                <h3 style={{ fontSize: '1.2rem', color: 'var(--text-dark-section)', marginBottom: '10px' }}>{item.title}</h3>
                <p style={{ color: 'var(--text-dark-section)', opacity: 0.7, fontSize: '0.92rem', lineHeight: 1.6 }}>{item.desc}</p>
              </div>
            ))}
          </div>
        </div>
